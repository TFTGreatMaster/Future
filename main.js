...
//     ]
// }
// // kiểu dữ liệu của lớp ngoài cùng là một Object
// // hits propety là một array chứa các object
// //find the job’s title, locations, salary, benefits, skills and requirements

// let hit = [];
// for (let i = 0; i < jobSearch.hits.length; i++) {
//     let salarys = {};
//     let requirements = {};
//     for (let value of Object.keys(jobSearch.hits[i])) {
//         if (value.toLowerCase().indexOf('salary') != -1) {
//             salarys[value] = jobSearch.hits[i][value]
//         }
//         if (value.toLowerCase().indexOf('requirement') != -1) {
//             requirements[value] = jobSearch.hits[i][value]
//         }
//     }
//     hit.push({
//         JobTitle: jobSearch.hits[i].jobTitle,
//         Locations: jobSearch.hits[i].locations,
//         Skills: jobSearch.hits[i].skills,
//         benefits: jobSearch.hits[i].benefits,
//         salarys: salarys,
...
// // Bài 7:
// let data = ['Jeans', 'T-shirt', 'Socks']
// while (true) { 
//     const inputs = prompt('Hi there, welcome to shop admin panel, what do you want (C, R, U, D)')
//     if(inputs.toLowerCase() === 'c') {
//         const create = prompt('enter the name of the new item:')
//         data.push(create)
//         alert('Done')
//     }else if (inputs.toLowerCase() === 'r') {
//         console.log(`the current items are:`);
//         for(let i=0; i<data.length;i++) {
//             console.log(`${i+1}. ${data[i]}`);
//         }
//     }else if (inputs.toLowerCase() === 'u') {
//         const indexUpdate = prompt('Enter the position you want to update:')
//         const valueUpdate = prompt('Enter the new Name:')
//         data.splice(indexUpdate,1,valueUpdate)
//         alert('Done')
//     }else if(inputs.toLowerCase() === 'd') {
//         const indexDelete = prompt('Enter the position you want to delete:')
...
// ]
// function readCourse(courses) {
//     let complete = []
//     for (let i = 0; i < courses.length; i++) {
//         if (courses[i].Complete === true) {
//             complete.push('x')
//         } else {
//             complete.push(' ')
//         }
...
//     for (let i = 0; i < courses.length; i++) {
//         console.log(`${i + 1}. [${complete[i]}] ${courses[i].Course}`);
//     }
// }

// while (true) {
//     const command = prompt('enter your command(New, Delete, Update, Complete')
//     if (command.toLowerCase() === 'new') {
//         const newCourse = prompt('Enter new task:')
//         courses.push({
//             Course: newCourse,
//             Complete: false
//         })
...
//         const positionUpdate = Number(prompt('Enter positon:'))
//         for (let i = 0; i < courses.length; i++) {
//             if (positionUpdate === i + 1) {
//                 const valueUpdate = prompt('Enter new title:', courses[i].Course);
//                 courses.splice(positionUpdate, 1, valueUpdate)
//             } else if (positionUpdate > i + 1) {
//                 alert('no item in position')
//             }
//         }
//         readCourse(courses)
//     } else if (command.toLowerCase() === 'complete') {
//         const positionComplete = Number(prompt('Enter positon:'))
//         if (positionComplete <= courses.length) {
//             courses[i].Complete = true
//         } else if (positionUpdate > courses.length) {
//             alert('no item in position')
//         }
//         readCourse(courses)
//     } else if (command.toLowerCase() === 'delete') {
//         const positionDelete = Number(prompt('Enter positon:'))
//         if (positionUpdate <= courses.length) {
//             courses.splice(positionDelete, 1)
//         } else if (positionUpdate > courses.length) {
//             alert('no item in position')
//         }
//         readCourse(courses)
...
// // Bài 9:
// const numbers = prompt('Nhập chuỗi số cách nhau bởi dấu phẩy:',0)
...
// //Bài 10:
// const numbers = prompt('Nhập chuỗi số cách nhau bởi dấu phẩy:',0)
// console.log(`The smallest number is ${Math.min.apply(Math, numbers)}`); 

// //Bài 11:
// const arr = [3, 4, 6, -9, 10, -88, 2];
// while(true){
//     const number = prompt('Nhập số bạn muốn kiểm tra:')
//     for(i=0;i<arr.length; i++) {
//         if(number == arr[i]) {
//             alert(`${number} có trong arr tại vị trí index: ${i}`);
//             break
//         }else {
//             alert(`${number} không có trong arr`);
//             break
//         }
//     }
// }
...
// console.log(mySheep);
// console.log(' ');
// let maxInNumbers = Math.max.apply(Math, mySheep)
// console.log(`now my biggest sheep has size ${maxInNumbers},let's shave it`);
// console.log(' ');
// mySheep.splice(mySheep.indexOf(maxInNumbers), 1, 8)
// console.log('after shearing, here is my flock:');
// console.log(mySheep);
// upSheep(mySheep)
// console.log(' ');
// const month = prompt('isMonth >1:')
